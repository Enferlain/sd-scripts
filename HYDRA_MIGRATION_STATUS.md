# [OUTDATED] Hydra Configuration Migration Status

> **NOTE:** This document is outdated. Please refer to `HYDRA_MIGRATION_PROGRESS.md` for the latest status and architectural decisions (specifically the rejection of the ArgsAdapter pattern).
...
- `fine_tune.py`
- _(And any other scripts in the `scripts/` directory)_
