...
class TestQuantizeWeight:
    ...
    def test_per_tensor_quantization(self):
        ...
        quantized, scale = quantize_weight("test.weight", tensor, torch.float8_e4m3fn, max_val, min_val, quantization_mode="tensor")
    ...
    def test_per_channel_quantization(self):
        ...
        quantized, scale = quantize_weight("test.weight", tensor, torch.float8_e4m3fn, max_val, min_val, quantization_mode="channel")
    ...
    def test_block_quantization(self):
        ...
        quantized, scale = quantize_weight(
            "test.weight", tensor, torch.float8_e4m3fn, max_val, min_val, quantization_mode="block", block_size=64
        )
    ...
    def test_non_2d_fallback_to_tensor(self):
        ...
        quantized, scale = quantize_weight("test.weight", tensor, torch.float8_e4m3fn, max_val, min_val, quantization_mode="block")
    ...
    def test_scale_is_float32(self):
        ...
        _, scale = quantize_weight("test.weight", tensor, torch.float8_e4m3fn, max_val, min_val, quantization_mode="tensor")
