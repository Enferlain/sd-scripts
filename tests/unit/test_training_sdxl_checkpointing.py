...
class TestSaveSDModelOnEpochEndOrStepwise:
    ...
    def test_calls_common_function(
        self, mock_sdxl_util, mock_sai_spec, mock_common,
        saving_config, metadata_config, loss_config, mock_models, mock_accelerator
    ):
    ...
    def test_v_parameterization_passed_to_metadata(
        self, mock_sdxl_util, mock_sai_spec, mock_common,
        saving_config, metadata_config, mock_models, mock_accelerator
    ):
...
class TestCommonParameters:
    ...
    def test_v_parameterization_from_loss_config(
        self, mock_sdxl_util, mock_sai_spec, mock_common,
        saving_config, metadata_config, mock_models
    ):
