...
class TestGetHiddenStatesSDXL:
    ...
    def test_max_token_length_chunking(self):
        ...
        enc2_out = {
            "hidden_states": [torch.randn(3, 77, 1280) for _ in range(33)],
            "last_hidden_state": torch.randn(3, 77, 1280)
        }
        text_encoder2.return_value = enc2_out
    ...
    def test_max_token_length_150(self):
        ...
        enc2_out = {
            "hidden_states": [torch.randn(4, 77, 1280) for _ in range(33)],
            "last_hidden_state": torch.randn(4, 77, 1280)
        }
        text_encoder2.return_value = enc2_out
