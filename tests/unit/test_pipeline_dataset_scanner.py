...
class TestScanDirectory:
    ...
    def test_finds_images(self, temp_image_dir):
        ...
        scanned = scan_directory(temp_image_dir)
    ...
    def test_non_recursive(self, temp_image_dir):
        ...
        scanned = scan_directory(temp_image_dir, recursive=False)
    ...
    def test_validation_split(self, temp_image_dir):
        ...
        scanned = scan_directory(temp_image_dir, validation_split=0.4, validation_seed=42)
