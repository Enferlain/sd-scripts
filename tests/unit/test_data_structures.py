...
class TestAugHelper:
    ...
    def test_color_aug_hue(self, monkeypatch):
        ...
        random_vals = [0.3, 0.6]
        def mock_random():
            if random_vals: return random_vals.pop(0)
            return 0.5
...
def make_subset_args(**kwargs):
    defaults = dict(
        image_dir="/tmp/img", is_reg=False, class_tokens="dog", caption_extension=".txt",
        metadata_file="/tmp/meta.json", conditioning_data_dir="/tmp/cond",
        cache_info=True, alpha_mask=False, num_repeats=1, shuffle_caption=False,
        caption_separator=",", keep_tokens=0, keep_tokens_separator="", secondary_separator=None,
        enable_wildcard=False, color_aug=False, flip_aug=False, face_crop_aug_range=None,
        random_crop=False, random_crop_padding_percent=0.0, caption_dropout_rate=0.0,
        caption_dropout_every_n_epochs=0, caption_tag_dropout_rate=0.0, caption_prefix=None,
        caption_suffix=None, token_warmup_min=0, token_warmup_step=0
    )
...
def test_dreambooth_subset_equality():
    ...
    kwargs = dict(
        is_reg=False, class_tokens="dog", caption_extension=".txt",
        cache_info=True, alpha_mask=False, num_repeats=1, shuffle_caption=False,
        caption_separator=",", keep_tokens=0, keep_tokens_separator="", secondary_separator=None,
        enable_wildcard=False, color_aug=False, flip_aug=False, face_crop_aug_range=None,
        random_crop=False, random_crop_padding_percent=0.0, caption_dropout_rate=0.0,
...
def test_finetuning_subset_equality():
    ...
    kwargs = dict(
        image_dir="/tmp/img",
        alpha_mask=False, num_repeats=1, shuffle_caption=False,
        caption_separator=",", keep_tokens=0, keep_tokens_separator="", secondary_separator=None,
        enable_wildcard=False, color_aug=False, flip_aug=False, face_crop_aug_range=None,
        random_crop=False, random_crop_padding_percent=0.0, caption_dropout_rate=0.0,
        caption_dropout_every_n_epochs=0, caption_tag_dropout_rate=0.0, caption_prefix=None,
...
def test_controlnet_subset_equality():
    ...
    kwargs = dict(
        ...
        cache_info=True, num_repeats=1, shuffle_caption=False,
        caption_separator=",", keep_tokens=0, keep_tokens_separator="", secondary_separator=None,
        enable_wildcard=False, color_aug=False, flip_aug=False, face_crop_aug_range=None,
        random_crop=False, random_crop_padding_percent=0.0, caption_dropout_rate=0.0,
        caption_dropout_every_n_epochs=0, caption_tag_dropout_rate=0.0, caption_prefix=None,
