...
class TestGetNoiseNoisyLatentsAndTimesteps:
    ...
    def test_noise_offset_applied_when_enabled(
        self, mock_noise_scheduler, sample_latents, default_timestep_config, default_training_config
    ):
...
class TestIPNoiseGamma:
    ...
    def test_ip_noise_gamma_applied_when_enabled(
        self, mock_noise_scheduler, sample_latents, default_timestep_config, default_training_config, default_regularization_config
    ):
