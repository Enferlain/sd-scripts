...
class TestRunLatentCaching:
    ...
    def test_creates_latent_cache_backend_via_strategies(self, mock_trainer):
        ...
        with (
            ...
            assert mock_trainer.latent_cache_backend == mock_strategy
...
class TestRunTECaching:
    ...
    def test_disk_mode_uses_caching_engine(self, mock_trainer):
        ...
        mock_te_cache_backend = MagicMock()
        mock_trainer.strategies.create_te_caching_strategy.return_value = mock_te_cache_backend
