...
class TestEulerSchedulerGL:
    def test_step_with_gradual_latent(self):
        ...
        with patch("library.pipelines.gradual_latent.EulerAncestralDiscreteScheduler.__init__", return_value=None):
            ...
            with (
                patch.object(EulerAncestralDiscreteSchedulerGL, "sigmas", new_callable=PropertyMock, create=True) as mock_sigmas,
                ...
                patch.object(
                    EulerAncestralDiscreteSchedulerGL, "is_scale_input_called", new_callable=PropertyMock, create=True
                ) as mock_scale_input,
            ):
