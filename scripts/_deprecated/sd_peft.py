"""Retired SD PEFT training entrypoint.
...
_DEPRECATED_SCRIPT_ERROR = (
    "scripts/_deprecated/sd_peft.py is retired and no longer tracks the active "
    "metadata backbone. Use `uv run python train.py --config-name=presets/sd_peft` instead."
)
