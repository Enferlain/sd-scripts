# model-family-metadata Specification

## Purpose
Define canonical typed model-family, realization, component, and artifact facts;
their ownership and durable identities; and the projection boundaries that
produce repo-owned and compatibility metadata without making external formats
