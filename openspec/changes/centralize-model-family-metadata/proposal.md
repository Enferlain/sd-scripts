...
- Make `modelspec.*`, family-specific `ss_*`, and string-only safetensors metadata projection outputs from accepted facts while preserving SD/SDXL/SD3 external parity.
