...
- [x] 9.1 Define the first trustworthy accounting questions and the accepted source facts required to answer them.
...
- [x] 10.5 Update resource, metadata, observability, and report documentation with the settled ownership model, including any final metadata item routing/validation registry decision.
