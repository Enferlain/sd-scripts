...
from library.models.sd_model_prep import _load_target_model
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--batch_size", type=int, default=16, help="batch size for processing with Text Encoder / Text Encoderで処理するときのバッチサイズ"
    )
    parser.add_argument(
        "--clip_skip",
        type=int,
