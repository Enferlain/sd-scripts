...
def main(args):
    ...
    if args.in_json is not None:
        ...
        logger.warning("captions for existing images will be overwritten")
    else:
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--caption_extension", type=str, default=".caption", help="extension of caption file"
    )
    parser.add_argument(
        "--full_path",
        action="store_true",
