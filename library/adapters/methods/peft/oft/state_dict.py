...
def load_oft_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load an OFT checkpoint payload from either PyTorch or safetensors format."""
...
def save_oft_state_dict(
    ...
    *,
    ...
    """Save a repo-owned OFT checkpoint payload for the provided modules."""
