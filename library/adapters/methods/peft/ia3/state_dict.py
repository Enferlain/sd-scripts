...
def load_ia3_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load an IA3 checkpoint payload from either PyTorch or safetensors format."""
...
def save_ia3_state_dict(
    ...
    *,
    ...
    """Save a repo-owned IA3 checkpoint payload for the provided modules."""
