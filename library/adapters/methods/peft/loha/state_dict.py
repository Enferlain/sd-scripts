...
def load_loha_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load a LoHa checkpoint payload from either PyTorch or safetensors format."""
...
def save_loha_state_dict(
    ...
    *,
    ...
    """Save a repo-owned LoHa checkpoint payload for the provided modules."""
