...
def load_lokr_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load a LoKr checkpoint payload from either PyTorch or safetensors format."""
...
def save_lokr_state_dict(
    ...
    *,
    ...
    """Save a repo-owned LoKr checkpoint payload for the provided modules."""
