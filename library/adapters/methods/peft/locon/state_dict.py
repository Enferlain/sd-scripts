...
from .module import LoconModule
...
def load_locon_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load a LoCon checkpoint payload from either PyTorch or safetensors format."""
...
def save_locon_state_dict(
    ...
    *,
    ...
    """Save a repo-owned LoCon checkpoint payload for the provided modules."""
