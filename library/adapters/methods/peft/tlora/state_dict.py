...
from .module import TloraModule
...
def load_tlora_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load a TLora checkpoint payload from either PyTorch or safetensors format."""
...
def save_tlora_state_dict(
    ...
    *,
    ...
    """Save a repo-owned TLora checkpoint payload for the provided modules."""
