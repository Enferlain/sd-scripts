...
def load_glora_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load a GLoRA checkpoint payload from either PyTorch or safetensors format."""
...
def save_glora_state_dict(
    ...
    *,
    ...
    """Save a repo-owned GLoRA checkpoint payload for the provided modules."""
