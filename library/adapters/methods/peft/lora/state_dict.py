...
def load_lora_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load a LoRA checkpoint payload from either PyTorch or safetensors format."""
...
def save_lora_state_dict(
    ...
    *,
    ...
    """Save a repo-owned LoRA checkpoint payload for the provided modules."""
