...
def load_abba_state_dict(weights_path: str) -> dict[str, torch.Tensor]:
    """Load an ABBA checkpoint payload from either PyTorch or safetensors format."""
...
def save_abba_state_dict(
    ...
    *,
    ...
    """Save a repo-owned ABBA checkpoint payload for the provided modules."""
