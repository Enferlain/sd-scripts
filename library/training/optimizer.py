...
def get_optimizer(optimizer_config: OptimizerConfig, trainable_params, optimizer_kwargs: Dict = {}) -> tuple[str, str, object]:
    ...
    if optimizer_type == "Lion".lower():
        ...
        # Check and adjust arguments appropriately
        ...
        if optimizer_kwargs["relative_step"]:
            ...
            # If trainable_params is a group: remove lr
            if type(trainable_params) == list and type(trainable_params[0]) == dict:
                has_group_lr = False
                for group in trainable_params:
                    p = group.pop("lr", None)
                ...
                if has_group_lr:
                    # Disable args for now TODO Not desirable because dependency is reversed
