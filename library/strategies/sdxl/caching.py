...
facet implementation and the SDXL-specific ``CacheBackend`` implementations used
by the data backend.
"""
...
class SdxlLatentsPipelineStrategy(CacheBackend):
    """
...
class SdxlTextEncoderPipelineStrategy(CacheBackend):
    """
