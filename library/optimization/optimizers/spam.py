...
from library.optimization.optimizers.utils import SSCCosineDecay, UPDATE_STRATEGY, copy_stochastic_, paper_orthograd
...
class StableSPAM(BaseOptimizer):
    ...
    :param gamma2: float.
    :param gamma3: float.
    :param t_max: int | None. total number of steps.
        ...
        for group in self.param_groups:
            ...
            for parameter in group["params"]:
                ...
                if use_adopt and state["step"] == 1:
                    ...
                    parameter_fp32.add_(update, alpha=-step_size)
