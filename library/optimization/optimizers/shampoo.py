...
from library.optimization.optimizers.utils.shampoo import (
    LayerWiseGrafting,
    PreConditioner,
    PreConditionerType,
    build_graft,
    ...
    def step(self, closure: Closure = None) -> Loss:
        ...
        for group in self.param_groups:
            ...
            for p in group["params"]:
                ...
                shampoo_grad: torch.Tensor = pre_conditioner.preconditioned_grad(grad) if is_precondition_step else grad
