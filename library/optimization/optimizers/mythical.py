...
class Mythical(Optimizer):
    ...
    Arguments:
        ...
        weight_decay_rate (float):
            ...
            (default: 0.998).
        amp (float):
            Beta-adjusted scaling parameter for adding the running nesterov average to the gradient, functionally acts
            as strength value for a low-pass filter. (default: 1.0).
        orthograd (bool):
    ...
    # Implementation from:
    # https://github.com/LoganBooker/prodigy-plus-schedule-free/blob/1d2cfa2fe692a828d46a5a29b9667ec924961ac7/prodigyplus/core_optimiser.py#L169C5-L177C48
    @torch.no_grad()
