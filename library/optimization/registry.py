...
_OPTIMIZER_REGISTRATIONS = [
    ...
    OptimizerRegistration(name="farmscropv2", target="library.optimization.optimizers.farmscrop_v2.FARMSCropV2", backend="repo"),
    ...
    OptimizerRegistration(name="scornmachina", target="library.optimization.optimizers.scornmachina.SCORNMachina", backend="repo"),
    ...
    OptimizerRegistration(name="wiwiopt", target="library.optimization.optimizers.wiwiopt.WiwiOpt", backend="repo"),
    OptimizerRegistration(
        name="adamw8bitkahan",
