...
_OPTIMIZER_REGISTRATIONS = [
    ...
    OptimizerRegistration(name="abmog", target="library.optimization.optimizers.experimental.abmog.ABMOG", backend="repo"),
    OptimizerRegistration(
    ...
    OptimizerRegistration(name="fishmonger", target="library.optimization.optimizers.experimental.fishmonger.FishMonger", backend="repo"),
    OptimizerRegistration(
    ...
    OptimizerRegistration(name="gooddog", target="library.optimization.optimizers.experimental.gooddog.GOODDOG", backend="repo"),
    ...
    OptimizerRegistration(name="mythical", target="library.optimization.optimizers.experimental.mythical.Mythical", backend="repo"),
    OptimizerRegistration(name="momentuscaution", target="library.optimization.optimizers.experimental.momentus_caution.MomentusCaution", backend="repo"),
    OptimizerRegistration(name="oagopt", target="library.optimization.optimizers.experimental.oagopt.OAGOpt", backend="repo"),
    OptimizerRegistration(name="ocgopt", target="library.optimization.optimizers.experimental.ocgopt.OCGOpt", backend="repo"),
    ...
    OptimizerRegistration(name="remaster", target="library.optimization.optimizers.experimental.remaster.REMASTER", backend="repo"),
    ...
    OptimizerRegistration(name="scgopt", target="library.optimization.optimizers.experimental.scgopt.SCGOpt", backend="repo"),
    OptimizerRegistration(name="scion", target="library.optimization.optimizers.scion.SCION", backend="repo"),
    OptimizerRegistration(name="singstate", target="library.optimization.optimizers.experimental.singstate.SingState", backend="repo"),
    ...
    OptimizerRegistration(name="talon", target="library.optimization.optimizers.experimental.talon.TALON", backend="repo"),
