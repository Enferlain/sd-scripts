...
class PeftConfig:
    ...
    train_unet_only: bool = field(default=False, metadata={"help": "only training U-Net part"})
    train_text_encoder_only: bool = field(default=False, metadata={"help": "only training Text Encoder part"})
