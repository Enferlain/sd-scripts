...
class PrecisionConfig:
    ...
    disable_cuda_reduced_precision_operations: bool = field(default=False, metadata={"help": "Disable TF32 and reduced precision for maximum accuracy"})
    enable_cuda_reduced_precision_operations: bool = field(default=False, metadata={"help": "Enable TF32 and reduced precision for faster computation"})
...
class MemoryConfig:
    ...
    direct_ramtorch: bool = field(default=False, metadata={"help": "Train original weights in LyCORIS full module and save diff instead of keeping both"})
