...
class ValidationConfig:
    ...
    validation_seed: int | None = field(default=None, metadata={"help": "Validation seed for shuffling validation dataset, training seed used otherwise"})
    ...
    validation_timesteps: str = field(default="[50, 350, 500, 650, 950]", metadata={"help": "A list of timesteps to use for each validation step"})  # TODO: do lists need quotes in hydra?
