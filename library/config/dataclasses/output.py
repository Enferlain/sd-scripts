...
class SavingConfig:
    ...
    output_dir: str | None = field(default=None, metadata={"help": "Directory for saving checkpoints and models"})
    ...
    save_every_n_epochs: int | None = field(default=None, metadata={"help": "Save checkpoint every N epochs"})
    save_every_n_steps: int | None = field(default=None, metadata={"help": "Save checkpoint every N training steps"})
...
class LoggingConfig:
    ...
    log_timestep_distribution_every_n_steps: int | None = field(default=None, metadata={"help": "Save timesteps distribution chart every N steps"})
...
class MetadataConfig:
    ...
    metadata_is_negative_embedding: str | None = field(default=None, metadata={"help": "Whether this is a negative embedding for model metadata"})
