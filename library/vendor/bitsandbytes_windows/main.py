...
def evaluate_cuda_setup():
    ...
    if cudart_path is None:
        print("WARNING: No libcudart.so found! Install CUDA or the cudatoolkit package (anaconda)!")
        return binary_name
    ...
    if cc == "":
        print("WARNING: No GPU detected! Check your CUDA paths. Processing to load CPU-only library...")
        return binary_name
