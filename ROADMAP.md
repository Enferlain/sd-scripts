...
- [ ] **Strategy system follow-up** — Desirable cleanup for fully strategy-owned token/TE shapes, trimming legacy/transitional surface from the `TrainingStrategy` contract, and removing remaining model-family assumptions from shared phases/utilities. See `docs_design/strategy_system_followup.md`.
